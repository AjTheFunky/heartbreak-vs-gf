	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'girlfriend-christmas':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('Girlfriend/GirlfriendChristmas');
				frames = tex;
				animation.addByPrefix('idle', 'Girlfriend idle dance', 24);
				animation.addByPrefix('singUP', 'Girlfriend Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Girlfriend Sing Note RIGHT', 24);
			...
			case 'girlfriend-car':
				...
				addOffset("singRIGHT", 2, -71);
				addOffset("singLEFT", 175, -20);
				addOffset("singDOWN", 33, -205);
			...
			case 'demongf':
				...
				addOffset('idle');
				addOffset("singUP", 7, 15);
				addOffset("singLEFT", 139, -29);
				addOffset("singRIGHT", -55, -16);
				addOffset("singDOWN", -51, -171);
